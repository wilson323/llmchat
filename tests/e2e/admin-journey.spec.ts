...
test.describe('T023: E2E管理员旅程', () => {
  const adminCreds = {
    username: 'admin',
    password: 'admin123',
  };

  test.describe('1️⃣ 管理员登录', () => {
